...
export function Fridge() {
    ...
    <div class="fridge__text">
        ...
        <p class="fridge__info">Don't want to go to the store? No problem! Enter the ingredients you have on hand, and we'll show you recipes you could make. For best results, enter 5 or more ingredients below, including staples like salt, pepper, and olive oil.</p>
    </div>
    ...
    <div class="fridge__ingredients__container">
        <h2 class="fridge__ingredients__title">your ingredients</h2>
